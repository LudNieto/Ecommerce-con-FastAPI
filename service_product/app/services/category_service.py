...
async def create_category(category_data: CategoryInput, db: Session) -> CategoryOut:
...
async def update_category(category_id: int, category_data: CategoryInput, db: Session) -> CategoryOut:
